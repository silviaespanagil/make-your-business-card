...
const cardDataSocialColor = document.querySelectorAll('.preview__card-socials--items');
...
function changePaletteColor(event) {
  ...
  switch (target.id) {
    case 'palette1':
      ...
      cardDataNameColor.classList.remove('changeNameColor2', 'changeNameColor3');

      cardDataProfColor.classList.add('changeProfColor1');
      cardDataProfColor.classList.remove('changeProfColor2', 'changeProfColor3');
    ...
    case 'palette2':
      ...
      cardDataNameColor.classList.remove('changeNameColor3', 'changeNameColor1');

      cardDataProfColor.classList.add('changeProfColor2');
      cardDataProfColor.classList.remove('changeProfColor1', 'changeProfColor3');
    ...
    case 'palette3':
      ...
      cardDataNameColor.classList.remove('changeNameColor1', 'changeNameColor2');

      cardDataProfColor.classList.add('changeProfColor3');
      cardDataProfColor.classList.remove('changeProfColor1', 'changeProfColor2');
